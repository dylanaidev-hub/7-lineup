...
import { ClipboardText, DeviceMobile, ShareNetwork, UsersThree } from "@phosphor-icons/react";
    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <HeroAnimatedTitle
            title="Một cách rõ ràng hơn để cả đội cùng nhìn thấy trận đấu"
        ...
        <div className={styles.principleList}>
          {principles.map(({ icon, title, body }, index) => (
            <article key={title}>
              ...
              <SiteIcon icon={icon} variant="principle" />
              <div>
                <h3>{title}</h3>
                <p>{body}</p>
              </div>
      ...
      <section className={styles.audience}>
        <SiteIcon icon={UsersThree} variant="spotlight" className={styles.audienceIcon} />
        <div>
